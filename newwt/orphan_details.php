...
$password="";
$dbname=$wtproject;
// getting details from form and updating table(manager)
if(isset($_POST['submit'])){
    ...
    $city = $_POST['city'];
    $sql = "update manager set username='$username',email='$email',contact='$contact',address='$address',city='$city' where username='$login_session'";
    if ($connection->query($sql) === TRUE) {
        echo "orphanage details updated successfully";
    } else {
        echo "Error changing details: " . $connection->error;
    }
    $connection->close();
}    
?>
...
<body>
    ...
    <h2 class="home">MANAGER | UPDATE-DETAILS</h2>
    <div class="upform">
        <form method="post">
        <div class="textbox">
            <i class="fa fa-user" aria-hidden="true"></i>
            <input type="text" placeholder="Orphanage-Name(username)" name="name" required>
        </div>
        <div class="textbox">
