...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"delete from manager where username = '".$_GET['username']."'");
...
<body>
    ...
    <h2 class="home">ADMIN | MANAGE ORPHANAGE</h2>
...
?>
                                            ...
                                            <tr align="center">
                                                ...
                                                <td><a href="admin_orphanage_manage.php?username=<?php echo $row['username']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-times fa fa-white"></i></a></td>
                                            </tr>
