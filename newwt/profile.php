    ...
    <div class="container-fluid" id="cont">
        <div class="row">
            <div id="col" class="col-sm" style="background-color: black;">
                ...
                <br>
                <a href="donar_details.php"><input class="btn" type="button" name="" value="Update"></a>
            </div>
            <div id="col" class="col-sm" style="background-color: black;">
                <h2 id="h22">My Kids</h2>
                <br>
                <img id="man" src="child.png" height="150px" width="150px">
                <br>
                <a href="donor_kid.php"><input class="btn" type="button" name="" value="Mentor"></a>
            </div>
            <div id="col" class="col-sm" style="background-color: black;">
                <h2 id="h23">Search</h2>
                <br>
                ...
                <br>
                <a href="searchchild.php"><input class="btn" type="button" name="" value="Search"></a>
            </div>
        </div>
    </div>
    <div id="info">
