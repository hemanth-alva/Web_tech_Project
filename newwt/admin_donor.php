...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"DELETE FROM signup WHERE username = '".$_GET['username']."'");
...
<h2 class="home">ADMIN | MANAGE DONOR</h2>
...
?>
                                            ...
                                            <tr align="center">
                                                ...
                                                <td><a href="admin_donor.php?username=<?php echo $row['username']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-times fa fa-white"></i></a></td>
                                            </tr>
