...
if(isset($_POST['submit'])){  // TAKING INFO FROM FORM
    ...
    $school = $_POST['school'];
    $area = $_POST['area'];
    //inserting into student details table
    $query ="INSERT INTO studentdet(uid,studentname,age,school,area) values($uid, $stname, $age, $school,$area)";
    $connection->query($query);
    if ($connection->query($query) === TRUE) {
        echo "student added successfully";
    } else {
        echo "Error adding student: " . $connection->error;
    }
    //inserting into student progress table
    $query ="INSERT INTO 'studentpro'('uid', 'studentname', 'currentgrade', 'upcomingevents','school','area') values($uid, $stname, '-','-', $school,$area)";
    if ($connection->query($query) === TRUE) {
        echo "student progress added successfully";
    } else {
        echo "Error adding student progress: " . $connection->error;
    }
}
$connection->close();
?>
...
<body>
    ...
    <h2 class="home">MANAGER | STUDENT-ADD</h2>
    <div class="upform">
    <div class="textbox">
        <form method="post">
