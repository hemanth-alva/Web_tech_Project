...
<head>
    ...
    <title>Dashboard:Orphanage</title>
    <style>
        * {
            margin: 0px;
            padding: 0px;
...
<body>
    ...
    <h1 class="home">ORPHANAGE|DASHBOARD</h1>
    <div class="container-fluid" id="cont">
        <div class="row">
            <div id="col" class="col-sm" style="background-color: black;">
                <h2 id="h21">Profile</h2>
                <br>
                <img id="man" src="donar.png" height="150px" width="150px">
                <br>
                <a href="orphan_details.php"><input class="btn" type="button" name="" value="Update"></a>
            </div>
            <div id="col" class="col-sm" style="background-color: black;">
                <h2 id="h22">Children</h2>
                <br>
                <img id="man" src="child.png" height="150px" width="150px">
                <br>
                <a href="mngchildren.php"><input class="btn" type="button" name="" value="View"></a>
            </div>
            <div id="col" class="col-sm" style="background-color: black;">
                <h2 id="h23">Progress</h2>
                <br>
                <img id="man" src="manager7.jpg" height="150px" width="150px">
                <br>
                <a href="student_update.php"><input class="btn" type="button" name="" value="Update"></a>
            </div>
        </div>
    </div>
    <div id="info">
